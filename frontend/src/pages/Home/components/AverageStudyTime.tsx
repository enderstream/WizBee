...
const AverageStudyTime: React.FC<AverageStudyTimeProps> = ({
  ...
  const myHours = averageStudyTimeData
    ? formatHours(averageStudyTimeData.data.userAvg)
    : 0
  const peerHours = averageStudyTimeData
    ? formatHours(averageStudyTimeData.data.userYearAvg)
    : 0
