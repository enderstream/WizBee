...
const Settings: React.FC = () => {
    ...
    const handleSaveProfile = (e: React.FormEvent) => {
        e.preventDefault()
        // 프로필 정보 저장 로직
        console.log("프로필 정보 저장:", { nickname, birthYear, birthMonth, birthDay, gender })
    ...
    return (
        <div className="settings-page">
            ...
            <div className="settings-buttons">
                ...
                <button className="settings-button" onClick={() => setShowLogoutModal(true)}>
                    로그아웃
                </button>

                <button className="settings-button delete-button" onClick={() => setShowDeleteModal(true)}>
                    회원 탈퇴
                </button>
            </div>
